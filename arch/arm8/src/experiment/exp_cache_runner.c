...
void _cache_run(cache_state second_cache, void (*_clean_mem_run)(), void (*_scamv_run)(), void (*_clean_mem_train)(), void (*_scamv_train)(), void (*_cache_line_to_evict)(), uint8_t _input_id, cache_state first_cache);

static cache_state cache_temp;
uint8_t cache_run_mult_compare(uint8_t _input_id, cache_state second_cache_, cache_state first_cache_, cache_line *cache_line_to_evict, uint8_t n) {
